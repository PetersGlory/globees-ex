    ...
    <SafeAreaView style={tw`flex-grow bg-gray-100 w-full h-full p-5`}>
        ...
        <ScrollView style={tw`w-full h-full ${Platform.OS == "ios" ? "p-5 w-full h-full" : ""}`}>
            ...
            <Text style={tw`text-center text-gray-500 mt-5 text-[12px]`}>
                Kindly review the {typeR} information provided and continue to make a deposit.
            </Text>
            ...
            <View style={tw`mt-5 w-full`}>
                ...
                <Text style={tw`mt-3 text-[12px] text-red-600 text-center`}>
                  Ensure all the information provided are accurate to avoid payment cancellation.
                </Text>
