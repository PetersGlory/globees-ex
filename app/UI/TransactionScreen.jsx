...
import { View, Text, SafeAreaView, ScrollView, TouchableOpacity, RefreshControl, Platform } from 'react-native'
...
const TransactionScreen = () => {
  ...
  return (
    <SafeAreaView style={tw`flex-grow w-full h-full bg-gray-100 p-5 pt-10 ${Platform.OS == "ios" && "pl-5 pr-5"}`}>
