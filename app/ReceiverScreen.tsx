    ...
    <SafeAreaView style={tw`bg-gray-100 w-full h-full p-5`}>
      ...
      >
        ...
        <Text style={tw`text-center text-gray-500 mt-5 text-[12px]`}>
          Kindly enter the correct receiver's account details
        ...
        <View style={tw`mt-5 w-full`}>
          <TextInput
            ...
            style={tw`p-[12px] rounded-lg border border-gray-300`}
          />
          <TextInput
            ...
            keyboardType="default"
            style={tw`p-[12px] rounded-lg border border-gray-300 mt-3`}
          />
          <TextInput
