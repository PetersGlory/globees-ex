...
const CustomSocial = ({visibility, setVisibility}) => {
            ...
            <View style={tw`mt-2 w-full p-2 flex flex-col h-[95%] items-center justify-center`}>
                ...
                <View style={tw`mt-5 flex flex-row items-center justify-between w-[70%]`}>
                    <TouchableOpacity style={tw`rounded-full p-2 bg-white`} onPress={()=>{
                        ...
                        <Icon name="md-logo-facebook" size={26} style={tw`text-center p-2 text-blue-800`} />
                    </TouchableOpacity>
                    <TouchableOpacity style={tw`rounded-full p-2 bg-white`} onPress={()=>{
                        Linking.openURL("https://twitter.com/globees_ex");
                    }}>
                        <Icon name="md-logo-twitter" size={26} style={tw`text-center p-2 text-blue-500`} />
                    </TouchableOpacity>
                    <TouchableOpacity style={tw`rounded-full p-2 bg-white`} onPress={()=>{
                        Linking.openURL("https://www.instagram.com/globees.ex/");
                    }}>
                        <Icon name="md-logo-instagram" size={26} style={tw`text-center p-2 text-red-800`} />
                    </TouchableOpacity>
                    <TouchableOpacity style={tw`rounded-full p-2 bg-white`} onPress={()=>{
                        Linking.openURL("https://t.me/globees_ex");
                    }}>
                        <Icon name="md-paper-plane" size={26} style={tw`text-center p-2 text-blue-700`} />
                    </TouchableOpacity>
                </View>
            </View>
        </View>
