...
const AccountDetails = () => {
  ...
  return (
    <SafeAreaView style={tw`flex-grow bg-white p-5 pt-10`}>
      ...
      >
        <CustomHeader title={"Globees Ex Bank Account"} />

        <Text style={tw`text-center text-gray-500 mt-5 text-[12px]`}>
          Transfer the exact deposit amount here and click PAID to continue.
        </Text>
        ...
        <View style={tw`w-full mt-5`}>
          ...
          <View style={tw`mt-5 w-full`}>
            ...
            <Text style={tw`mt-3 text-[12px] text-gray-600`}>
              Do not click PAID if the payment has not yet been sent from your bank account.
              Ensure to send the exact deposit amount to instantly process your payment.
              If otherwise, your payment will be automatically cancelled
            </Text>
          </View>
        </View>
      </View>
